...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es">
    ...
    <body>
        ...
        <%@include file="navbar.jsp" %>
            ...
            <!-- SECCIÓN AJAX PARA BÚSQUEDA RÁPIDA -->
            ...
            <script type="text/babel">
                ...
                // En tu Conexion.jsp, antes del React, agrega esto para obtener el rol del usuario
                const usuarioRol = '<%= session.getAttribute("usuario") != null ? ((Logica.Usuario) session.getAttribute("usuario")).getRol() : ""%>';
                ...
                const App = function () {
                    ...
                    // NUEVO: Menú de Gestión de Usuarios (solo para admin)
                    const usuariosItems = [
                        {label: 'Agregar Usuario', link: 'AgregarUsuario.jsp'},
                        {label: 'Lista de Usuarios', link: 'ListarUsuarios.jsp'}
                    ];
                    ...
                    return React.createElement('div', {className: 'react-container'},
                            ...
                            usuarioRol === 'admin' && React.createElement('div', {className: 'menu-section fade-in'},
                                    React.createElement('h2', null, 'Gestión de Usuarios (Admin)'),
                                    React.createElement('div', {className: 'menu-buttons'},
                                            React.createElement(DropdownMenu, {
                                                title: 'Usuarios',
                                                items: usuariosItems
            ...
            <!-- Script AJAX para búsqueda en página principal -->
