...
public class SvEditarProducto extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //String n = request.getParameter("nuevo_nombre_producto");
            ProductoDAO dao = new ProductoDAO();
            ...
            // CORREGIDO: Usar los mismos nombres que el JSP
            // Nombre
            String nuevoNombre = request.getParameter("nuevo_nombre_producto"); // CORREGIDO
            if (nuevoNombre != null && !nuevoNombre.trim().isEmpty()) {
                productoActual.setNombreProducto(nuevoNombre.trim());
            }

            // Precio
            String precioStr = request.getParameter("nuevo_precio_producto"); // CORREGIDO
            ...
            // Cantidad
            String cantidadStr = request.getParameter("nueva_cantidad_producto"); // CORREGIDO
            ...
            // Categoría
            String categoriaStr = request.getParameter("nueva_categoria_id"); // CORREGIDO
            ...
            // Descripción
            String nuevaDescripcion = request.getParameter("nueva_descripcion"); // CORREGIDO
            ...
            e.printStackTrace();
            request.setAttribute("mensaje", "Error interno del servidor" + e);
